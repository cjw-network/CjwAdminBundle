...
/**
 * The MIT License
 * Copyright (c) 2010-2015 Stepan Suvorov http://stepansuvorov.com
 * ng-wig.js version: 2.3.3
 */
...
*/
!function(){function t(){return{restrict:"AEC",require:"dxStartWith",controller:"dxStartWithCtrl",scope:!0,terminal:!0,transclude:!0,multiElement:!0,$$tlb:!0,compile:function(t,n){var r=n.dxStartWith||n.root,i=r.match(e),a=i[1],c=i[3]||""
return function(t,n,r,e,i){e.alias=c,e.transclude=i,e.transclude(t,function(t,r){function e(t){r.$dxPrior=t,""!==c&&(r[c]=t)}n.append(t),r.$dxLevel=0,r.$dxIsRoot=!0,r.$watch(a,e)})}}}}function n(){return{restrict:"AEC",require:"^dxStartWith",scope:!0,terminal:!0,multiElement:!0,compile:function(t,n){var r=n.dxConnect||n.connect
return function(t,n,e,i){alias=i.alias||"",i.transclude(t,function(t,e){function i(t){e.$dxPrior=t,""!==alias&&(e[alias]=t)}n.append(t),e.$dxLevel=e.$dxLevel+1,e.$dxIsRoot=!1,e.$watch(r,i)})}}}}var r=angular.module("dotjem.angular.tree",[]),e=/^(\S+)(\s+as\s+(\w+))?$/
r.controller("dxStartWithCtrl",[function(){}]),r.directive("dxStartWith",t),r.directive("dxConnect",n)}()
