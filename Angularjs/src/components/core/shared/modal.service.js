...
angular.module('ezpAppCore').factory('modalService', ['$animate', '$document', '$compile', '$controller', '$rootScope', '$q', '$templateRequest', '$timeout',
  function($animate, $document, $compile, $controller, $rootScope, $q, $templateRequest, $timeout) {
